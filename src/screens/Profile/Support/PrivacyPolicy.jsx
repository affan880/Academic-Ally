        ...
        <View style={styles.bodyContent}>
          ...
          <View style={styles.content}>
            <Text style={styles.normalText}>
              ...
              SERVICE is provided by Academic Ally at no cost and is intended
              for use as is.
            </Text>
            <Text style={styles.normalText}>
            ...
            <Text style={styles.normalText}>
              ...
              our Terms and Conditions, which are accessible at Academic Ally
              unless otherwise defined in this Privacy Policy.
            </Text>
            <Text style={styles.label}>Information Collection and Use</Text>
            <Text style={styles.normalText}>
              For a better experience, while using our Service, we may require
              you to provide us with certain personally identifiable
              information, including but not limited to name, email address. The
            ...
            <Text style={styles.label}>Log Data</Text>
            <Text style={styles.normalText}>
            ...
            <Text style={styles.normalText}>To facilitate our Service;</Text>
            <Text style={styles.normalText}>
            ...
            <Text style={styles.label}>Links to Other Sites</Text>
            <Text style={styles.normalText}>
            ...
            <Text style={styles.label}>Children’s Privacy</Text>
            <Text style={styles.normalText}>
