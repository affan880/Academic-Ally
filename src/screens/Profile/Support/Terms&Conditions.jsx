...
const TermsAndConditions = () => {
  ...
  const styles = useMemo(
    () => createStyles(theme.colors, theme.sizes),
    [theme],
  );
  return (
        ...
        <View style={styles.bodyContent}>
          ...
          <View style={styles.content}>
            <Text style={styles.normalText}>
              ...
              property rights related to it, still belong to Academic Ally.
            </Text>
            <Text style={styles.normalText}>
              Academic Ally is committed to ensuring that the app is as useful
            ...
            <Text style={styles.normalText}>
              The Academic Ally app stores and processes personal data that you
              ...
              security features and it could mean that the Academic Ally app
            ...
            <Text style={styles.normalText}>
              You should be aware that there are certain things that Academic
              Ally will not take responsibility for. Certain functions of the
              ...
              provider, but Academic Ally cannot take responsibility for the app
            ...
            <Text style={styles.normalText}>
              Along the same lines, Academic Ally cannot always take
              ...
              and you can’t turn it on to avail the Service, Academic Ally
              cannot accept responsibility.
            </Text>
            <Text style={styles.normalText}>
              With respect to Academic Ally’s responsibility for your use of the
              ...
              to us so that we can make it available to you. Academic Ally
            ...
            <Text style={styles.normalText}>
              ...
              available on Android – the requirements for the both systems(and
              ...
              you want to keep using the app. Academic Ally does not promise
            ...
            <Text style={styles.normalText}>Contact Us</Text>
            <Text style={styles.normalText}>
