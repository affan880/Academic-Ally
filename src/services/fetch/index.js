...
// export const userFirestoreData = async (userData, type, item, dispatch) => {
//   const storedData = await AsyncStorage.getItem('visitedSubjects').then((data) => JSON.parse(data));
//   const storedVersion = await AsyncStorage.getItem('versionKeys');
//   let list = [];
//   const latestData = await firestore()
//     .collection('Universities')
//     .doc(`${userData.university}`)
//     .collection(`${userData.course}`)
//     .doc(`${userData.branch}`)
//     .collection(`${userData.sem}`)
//     .doc(type)
//     .collection(item.subjectName).get();
//   if (storedData[type][item.subjectName]) {
//     return storedData[type][item.subjectName];
//   }
//   else {
//     console.log('new');
...
//       list.push(doc.data());
//     });
//     dispatch(setVisitedSubjects({ subject: list, status: type, subjectName: item.subjectName, branch: userData.branch, sem: userData.sem, versionKey: latestData.verion }));
//   }
//   return list;
// }
